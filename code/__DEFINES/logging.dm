...
#define LOG_LOOC (1 << 23) // PSYCHONAUT ADDITION - LOOC
#define LOG_HALLUCINATION (1 << 24) // PSYCHONAUT ADDITION - SCHIZO
...
#define INDIVIDUAL_LOOC_LOG (LOG_LOOC | LOG_ADMIN) // PSYCHONAUT ADDITION - LOOC
#define INDIVIDUAL_HALLUCINATION_LOG (LOG_HALLUCINATION) // PSYCHONAUT ADDITION - SCHIZO
#define INDIVIDUAL_SHOW_ALL_LOG (LOG_ATTACK | LOG_SAY | LOG_WHISPER | LOG_EMOTE | LOG_RADIO_EMOTE | LOG_DSAY | LOG_PDA | LOG_CHAT | LOG_COMMENT | LOG_TELECOMMS | LOG_OOC | LOG_ADMIN | LOG_OWNERSHIP | LOG_GAME | LOG_ADMIN_PRIVATE | LOG_ASAY | LOG_MECHA | LOG_VIRUS | LOG_SHUTTLE | LOG_ECON | LOG_VICTIM | LOG_SPEECH_INDICATORS | LOG_LOOC | LOG_HALLUCINATION) // PSYCHONAUT EDIT ADDITION - LOOC - SCHIZO - ADDED: LOG_LOOC, LOG_HALLUCINATION
...
#define LOG_CATEGORY_GAME_LOOC "game-looc" // PSYCHONAUT ADDITION - LOOC
...
#define LOG_CATEGORY_GAME_JUKEBOX "game-jukebox" // PSYCHONAUT ADDITION - JUKEBOX
#define LOG_CATEGORY_GAME_HALLUCINATION "game-hallucination" // PSYCHONAUT ADDITION - SCHIZO
#define LOG_CATEGORY_STORYTELLER "storyteller" // PSYCHONAUT ADDITION - STORYTELLERS
