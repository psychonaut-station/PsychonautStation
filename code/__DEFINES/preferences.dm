...
#define CHAT_LOOC (1<<13) // PSYCHONAUT ADDITION - LOOC

#define TOGGLES_DEFAULT_CHAT (CHAT_OOC|CHAT_DEAD|CHAT_PRAYER|CHAT_PULLR|CHAT_GHOSTPDA|CHAT_GHOSTRADIO|CHAT_BANKCARD|CHAT_GHOSTLAWS|CHAT_LOGIN_LOGOUT|CHAT_LOOC) // PSYCHONAUT EDIT ADDITION - LOOC - ADDED: CHAT_LOOC
