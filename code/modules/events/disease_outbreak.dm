...
/datum/round_event/disease_outbreak/announce(fake)
	...
	priority_announce("[locale_suffix_genitive(station_name())] içerisinde 7. seviye viral biyolojik tehlike salgını olduğu doğrulandı. Tüm personeller salgını kontrol altına almalıdır.", "[illness_type] Uyarısı", ANNOUNCER_OUTBREAK7)
