...
/obj/item/stake
	...
	icon = 'psychonaut_modules/features/antagonists/bloodsuckers/icons/stakes.dmi'
	icon_state = "wood"
	inhand_icon_state = "wood"
	lefthand_file = 'psychonaut_modules/features/antagonists/bloodsuckers/icons/bs_leftinhand.dmi'
	righthand_file = 'psychonaut_modules/features/antagonists/bloodsuckers/icons/bs_rightinhand.dmi'
