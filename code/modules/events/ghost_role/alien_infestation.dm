...
/datum/round_event/ghost_role/alien_infestation/announce(fake)
	...
	if(living_aliens || fake)
		priority_announce("[locale_suffix_dative(station_name())] doğru gelen tanımlanamayan yaşam sinyalleri tespit edildi. Borular ve havalandırma da dahil olmak üzere tüm dış erişimleri emniyete alın.", "Yaşam Sinyali", ANNOUNCER_ALIENS)
