...
/datum/antagonist/space_dragon/proc/victory()
	...
	priority_announce("Çok sayıda yaşam formunun [station_name()] İstasyonuna aşırı hızlarda yaklaştığı tespit edildi. \
		Kalan mürettebatın mümkün olan en kısa sürede tahliye edilmesi tavsiye edilmektedir.", "[command_name()] Vahşi Yaşam İzleme", has_important_message = TRUE)
