...
/datum/greyscale_config/New()
	...
	// PSYCHONAUT EDIT CHANGE START - GAGS - ORIGINAL:
	// if(findtext(string_json_config, "code/datums/greyscale/json_configs/") != 1)
	if(findtext(string_json_config, "code/datums/greyscale/json_configs/") != 1 && findtext(string_json_config, "modular_psychonaut/modules/GAGS/code/json_configs/") != 1)
