...
/datum/transport_controller/linear/tram/proc/rod_collision(obj/effect/immovablerod/collided_rod)
	...
	priority_announce("Oldukça tuhaf bir olay sonucunda, [GLOB.station_name] hareketsiz bir çubuğa çarpmış gibi görünüyor. (Nereden geldiğini bizde bilmiyoruz.) Bu durum tramvay platformlarından birinde frenlerinin arızalanmasına yol açtı.\n\n\
