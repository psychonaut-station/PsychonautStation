...
/mob/dead/get_status_tab_items()
	...
	. += "Players Ready: [SSticker.totalPlayersReady]" // PSYCHONAUT EDIT ADDITION - PLAYERS_READY
	if(client.holder)
		// . += "Players Ready: [SSticker.totalPlayersReady]" // PSYCHONAUT EDIT REMOVAL - PLAYERS_READY
