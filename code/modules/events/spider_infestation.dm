...
/datum/round_event/spider_infestation/announce(fake)
	priority_announce("[station_name()] içerisinden gelen tanımlanamayan yaşam sinyalleri tespit edildi. Borular ve havalandırma da dahil olmak üzere tüm dış erişimleri emniyete alın.", "Yaşam Sinyali", ANNOUNCER_ALIENS)
