/datum/surgery_operation/limb/prepare_cavity
	...
	localizated_desc = "Daha büyük eşyaların implant edilmesine izin vermek için hastanın göğüs boşluğunu genişletin."
	implements = list(
		TOOL_RETRACTOR = 1,
		TOOL_CROWBAR = 1.5,
	)
...
/datum/surgery_operation/limb/cavity_implant
	...
	localizated_desc = "Hastanın vücut boşluğuna bir eşya implant edin."
...
/datum/surgery_operation/limb/undo_cavity_implant
	...
	localizated_desc ="Vücut boşluğundan bir eşyayı çıkarın."
	implements = list(
		IMPLEMENT_HAND = 1,
		TOOL_HEMOSTAT = 2,
		TOOL_CROWBAR = 2.5,
