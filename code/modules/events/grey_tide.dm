...
/datum/round_event/grey_tide/announce(fake)
	if(fake)
		severity = rand(1,3)
	priority_announce("[station_name()] İstasyonu'nun güvenli kilitleme şifreleme alt programlarında Gr3y.T1d3 virüsü tespit edildi. Önem derecesi [severity] olarak belirlendi. İstasyon AI katılımını tavsiye edin.", "Güvenlik Uyarısı")
