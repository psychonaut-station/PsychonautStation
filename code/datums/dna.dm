...
/datum/dna/proc/generate_unique_features()
	...
	if(features["arachnid_appendages"])
		L[DNA_ARACHNID_APPENDAGES_BLOCK] = construct_block(GLOB.arachnid_appendages_list.Find(features["arachnid_appendages"]), GLOB.arachnid_appendages_list.len)
	if(features["arachnid_chelicerae"])
		L[DNA_ARACHNID_CHELICERAE_BLOCK] = construct_block(GLOB.arachnid_chelicerae_list.Find(features["arachnid_chelicerae"]), GLOB.arachnid_chelicerae_list.len)
