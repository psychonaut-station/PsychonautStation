...
/obj/item/clothing/suit/hooded/cultrobes/alt
	...
	pony_icon_state = "cultrobe"
	pony_config_path = /datum/greyscale_config/pony_clothes_override

/obj/item/clothing/suit/hooded/cultrobes/alt/generate_pony_icons(icon/base_icon, greyscale_colors)
...
/obj/item/shuttle_curse/attack_self(mob/living/user)
	...
	if(SSshuttle.emergency.mode == SHUTTLE_CALL)
		...
		priority_announce("[curse_message]", "Sistem Hatası", 'sound/announcer/notice/notice1.ogg')
		...
		if(totalcurses >= MAX_SHUTTLE_CURSES && (world.time < first_curse_time + SHUTTLE_CURSE_OMFG_TIMESPAN))
			...
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(priority_announce), omfg_message, "Öncelikli Uyarı", 'sound/announcer/announcement/announce_syndi.ogg', null, "Nanotrasen Ulaştırma Departmanı"), rand(2 SECONDS, 6 SECONDS))
