/mob/living/basic/vada
	...
	icon = 'modular_psychonaut/master_files/icons/mob/simple/vada.dmi'
	icon_state = "vada"
	icon_living = "vada"
	icon_dead = "vada_dead"
	...
	light_color = "#d43229"
	death_sound = 'modular_psychonaut/master_files/sound/mobs/non-humanoids/wada.ogg'
...
/datum/ai_planning_subtree/random_speech/vada
	...
	sound = list('modular_psychonaut/master_files/sound/mobs/non-humanoids/wada.ogg')
