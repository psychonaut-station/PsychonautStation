...
/datum/grand_finale/cheese/trigger(mob/living/invoker)
	...
	priority_announce("Tehlike: İstasyonda son derece güçlü gerçekliği değiştiren bir nesne ortaya çıktı. Acil tahliye tavsiye edilir. Çarpışmaya hazır olun.", "[command_name()] Yüksek Boyutlu İlişkiler", 'sound/effects/glassbr1.ogg')
