/datum/antagonist/cult
	...
	///List of cult recipe typepaths learned (Autogenerated based on CAT_CULT recipes)
...
/datum/antagonist/cult/on_gain()
	...
	if(isnull(cult_recipes))
		cult_recipes = list()
		for(var/datum/crafting_recipe/recipe_type as anything in typesof(/datum/crafting_recipe))
			if(recipe_type::category == CAT_CULT)
				cult_recipes += recipe_type
