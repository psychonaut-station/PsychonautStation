...
/mob/living/carbon/proc/ReturnVampExamine(mob/living/viewer)
	...
	if(viewer.mind.has_antag_datum(/datum/antagonist/vassal) in bloodsuckerdatum.vassals)
		...
		var/returnIcon = "[icon2html('psychonaut_modules/features/antagonists/bloodsuckers/icons/vampiric.dmi', world, "bloodsucker")]"
		returnString += "\n"
...
/mob/living/carbon/proc/ReturnVassalExamine(mob/living/viewer)
	...
	if(vassaldatum?.master.owner == viewer.mind)
		...
		returnIcon = "[icon2html('psychonaut_modules/features/antagonists/bloodsuckers/icons/vampiric.dmi', world, "vassal")]"
	// Am I someone ELSE'S Vassal?
		...
		returnIcon = "[icon2html('psychonaut_modules/features/antagonists/bloodsuckers/icons/vampiric.dmi', world, "vassal_grey")]"
