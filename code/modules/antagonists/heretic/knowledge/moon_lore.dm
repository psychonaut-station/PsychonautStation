...
/datum/heretic_knowledge/ultimate/moon_final/on_finished_recipe(mob/living/user, list/selected_atoms, turf/loc)
	...
	priority_announce("[generate_heretic_text()] Gülün, çünkü [user.real_name] dirildi! \
					Gerçek eninde sonunda yalanı yutacaktır! [generate_heretic_text()]","[generate_heretic_text()]", ANNOUNCER_SPANOMALIES)
