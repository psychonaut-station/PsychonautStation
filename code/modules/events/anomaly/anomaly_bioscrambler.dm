...
/datum/round_event/anomaly/anomaly_bioscrambler/announce(fake)
	...
	priority_announce("[ANOMALY_ANNOUNCE_MEDIUM_TEXT] [impact_area.name] bölgesinde biyolojik uzuv değiştirme maddesi tespit edildi. Etkilerine karşı koymak için biyo giysiler veya diğer koruyucu donanımları kullanın. Hesaplanan yaşam süresi %9£$T$%F3 yıl.", "Anomali Uyarısı")
