...
/datum/round_event/disease_outbreak/announce(fake)
	...
	priority_announce("[station_name()] İstasyonu'nda 7. seviye viral biyolojik tehlike salgını doğrulandı. Tüm personel salgını kontrol altına almalıdır.", "[illness_type] Uyarısı", ANNOUNCER_OUTBREAK7)
