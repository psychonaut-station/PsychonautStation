...
/obj/item/organ/internal/eyes/night_vision/arachnid/on_insert(mob/living/carbon/eye_owner)
	. = ..()
	if(!ishuman(eye_owner))
		return
...
/obj/item/organ/internal/eyes/night_vision/arachnid/on_remove(mob/living/carbon/eye_owner)
	. = ..()
	if(!ishuman(eye_owner))
		return
	var/mob/living/carbon/human/human_receiver = eye_owner
