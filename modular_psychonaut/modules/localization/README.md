...
- `code/modules/shuttle/mobile_port/variants/emergency/emergency_console.dm`: `/obj/machinery/computer/emergency_shuttle/ui_act()`, `/obj/machinery/computer/emergency_shuttle/process()`, `/obj/machinery/computer/emergency_shuttle/proc/announce_hijack_stage()`
- `code/modules/shuttle/shuttle_events/turbulence.dm`: `/datum/shuttle_event/turbulence/activate()`
- `code/modules/spells/spell_types/shapeshift/_shapeshift.dm`: `/datum/action/cooldown/spell/shapeshift/proc/eject_from_vents()`
- `code/modules/station_goals/meteor_shield.dm`: `/datum/transport_controller/linear/tram/proc/rod_collision()`
- `code/modules/station_goals/meteor_shield.dm`: `/obj/machinery/satellite/meteor_shield/proc/handle_new_emagged_shield_threshold()`
