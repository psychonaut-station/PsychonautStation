/datum/species/ipc
	...
	body_markings = list(
		/datum/bodypart_overlay/simple/body_marking/ipc = "Black",
	)
	mutant_organs = list(
...
/datum/action/innate/change_monitor
	...
	button_icon = 'modular_psychonaut/master_files/icons/mob/actions/actions_silicon.dmi'
...
/datum/action/innate/change_monitor/proc/give_overlay(mob/living/carbon/C, obj/item/bodypart/bodypart, datum/bodypart_overlay/simple/ipcscreen/overlay_typepath)
	...
	if(!isnull(overlay_typepath::icon_state))
		...
		if(overlay.locked)
			var/image/holo_animation = image('modular_psychonaut/master_files/icons/mob/human/species/ipc/ipc_screens.dmi', C, "hologram")
...
/datum/bodypart_overlay/simple/ipcscreen
	icon = 'modular_psychonaut/master_files/icons/mob/human/species/ipc/ipc_screens.dmi'
