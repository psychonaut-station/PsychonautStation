...
export function ThreeDiskNukeBomb(props) {
  const { act, data } = useBackend<Data>();
  const { status1, status2 } = data;

  return (
    <Window width={450} height={442} theme="retro">
      <Window.Content>
        <Box m={1}>
          ...
          <Stack mb={1.5}>
            ...
            <Stack.Item>
              <Button
                ...
                onClick={() => act('eject_disk', {disktype: 'red'})}
              />
              <Button
                icon="eject"
                iconColor='green'
                ...
                mt={0.5}
                className="NuclearBomb__Button NuclearBomb__Button--keypad"
                onClick={() => act('eject_disk', {disktype: 'green'})}
              />
              <Button
                icon="eject"
                iconColor='blue'
                ...
                mt={0.5}
                className="NuclearBomb__Button NuclearBomb__Button--keypad"
                onClick={() => act('eject_disk', {disktype: 'blue'})}
              />
            </Stack.Item>
          </Stack>
          <Stack ml={0.5}>
