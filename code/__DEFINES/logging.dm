...
#define LOG_LOOC (1 << 23) // PSYCHONAUT EDIT ADDITION - LOOC
...
#define INDIVIDUAL_LOOC_LOG (LOG_LOOC | LOG_ADMIN) // PSYCHONAUT EDIT ADDITION - LOOC
...
#define LOG_CATEGORY_GAME_LOOC "game-looc" // PSYCHONAUT EDIT ADDITION - LOOC
