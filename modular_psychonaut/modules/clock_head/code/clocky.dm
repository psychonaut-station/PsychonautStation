/obj/item/clothing/head/helmet/clocky
	...
	icon = 'modular_psychonaut/master_files/icons/mob/clothing/head/clocky.dmi'
	worn_icon = 'modular_psychonaut/master_files/icons/mob/clothing/head/clocky.dmi'
	lefthand_file = 'modular_psychonaut/master_files/icons/mob/inhands/clothing/dante_lefthand.dmi'
	righthand_file = 'modular_psychonaut/master_files/icons/mob/inhands/clothing/dante_righthand.dmi'
...
/obj/item/clothing/head/helmet/clocky/proc/handle_speech(datum/source, list/speech_args)
	...
	if(selected_sound == "Tick Tock!!")
		playsound(src, 'modular_psychonaut/master_files/sound/effects/dante_panic.ogg', 75, FALSE)
