...
/datum/grand_finale/cheese/trigger(mob/living/invoker)
	...
	priority_announce("Tehlike: İstasyonda son derece güçlü gerçekliği değiştiren bir nesne ortaya çıktı. Acil tahliye tavsiye edilmektedir. Etkisine karşı hazırlıklı olun.", "[command_name()] Üst Boyutlu İlişkiler", 'sound/effects/glass/glassbr1.ogg')
