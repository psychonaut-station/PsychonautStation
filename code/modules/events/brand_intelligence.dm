...
/datum/round_event/brand_intelligence/announce(fake)
	...
	priority_announce("[locale_suffix_genitive(station_name())] içerisinde kontrolden çıkmış bir marka tespit edildi. Lütfen tüm [machine_name] marka otomatları agresif pazarlama taktikleri açısından denetleyin ve gerekirse sıfırlayın.", "Makine Öğrenimi Uyarısı")
