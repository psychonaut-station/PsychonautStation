/obj/vehicle/sealed/car/retroline
	name = "Retroline"
	desc = "Bu araç, Nanotrasen tarafından üretilen eski tip, sivil kullanım için uygun, iki kişilik standart bir modeldir."
...
/obj/vehicle/sealed/car/retroline/generate_actions()
	. = ..()
...
/obj/vehicle/sealed/car/retroline/welder_act(mob/living/user, obj/item/W)
	if(user.combat_mode)
		return
	. = TRUE
...
/obj/vehicle/sealed/car/retroline/atom_break()
	START_PROCESSING(SSobj, src)
	return ..()

/obj/vehicle/sealed/car/retroline/process(seconds_per_tick)
...
/obj/vehicle/sealed/car/retroline/bullet_act(obj/projectile/P)
