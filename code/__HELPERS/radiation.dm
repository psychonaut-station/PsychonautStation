...
/proc/radiation_pulse(
	...
	intensity = 0, // PSYCHONAUT ADDITION - SINGULARITY_ENGINE
)
	...
	pulse_information.intensity = intensity || (max_range * 250) // PSYCHONAUT ADDITION - SINGULARITY_ENGINE
...
/datum/radiation_pulse_information
	...
	var/intensity // PSYCHONAUT ADDITION - SINGULARITY_ENGINE
