...
// PSYCHONAUT EDIT ADDITION BEGIN - WORKER - Original:
/*
...
// PSYCHONAUT EDIT ADDITION END - WORKER
...
#define JOB_DISPLAY_ORDER_WORKER 20.5
...
#define JOB_DISPLAY_ORDER_BRIG_PHYSICIAN 38.5 // PSYCHONAUT EDIT ADDITION - BRIG_PHYSICIAN
