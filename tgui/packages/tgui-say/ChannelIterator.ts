export type Channel = 'Say' | 'Radio' | 'Me' | 'OOC' | 'LOOC' | 'Admin'; // PSYCHONAUT ADDITION - LOOC - Added: 'LOOC'
...
export class ChannelIterator {
  ...
  private readonly channels: Channel[] = ['Say', 'Radio', 'Me', 'OOC', 'LOOC', 'Admin']; // PSYCHONAUT ADDITION - LOOC - Added: 'LOOC'
  private readonly blacklist: Channel[] = ['Admin'];
  private readonly quiet: Channel[] = ['OOC', 'LOOC', 'Admin']; // PSYCHONAUT ADDITION - LOOC - Added: 'LOOC'
