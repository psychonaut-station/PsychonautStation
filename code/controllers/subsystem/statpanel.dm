...
/datum/controller/subsystem/statpanels/fire(resumed = FALSE)
	if (!resumed)
		...
		global_data += list(
			"Storyteller: [(CONFIG_GET(flag/public_storyteller) && !isnull(SSstoryteller.current_storyteller)) ? SSstoryteller.current_storyteller.name : "Secret"]", // PSYCHONAUT ADDITION - STORYTELLERS
