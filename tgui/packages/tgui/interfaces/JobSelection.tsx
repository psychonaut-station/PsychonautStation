...
const get_security_level = (level: number) => {
  switch (level) {
    case SEC_LEVEL_GREEN:
      return (
        <NoticeBox success>The current alert level is: Green</NoticeBox>
      );
    case SEC_LEVEL_BLUE:
      return (
        <NoticeBox info>The current alert level is: Blue</NoticeBox>
      );
    case SEC_LEVEL_RED:
      return (
        <NoticeBox danger>The current alert level is: Red</NoticeBox>
      );
