...
#define span_mentorsay(str) ("<span class='mentorsay'>" + str + "</span>") // PSYCHONAUT ADDITION - MENTOR
#define span_mentorsaytext(str) ("<span class='mentorsaytext'>" + str + "</span>") // PSYCHONAUT ADDITION - MENTOR
