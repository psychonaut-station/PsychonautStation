...
*/
GLOBAL_LIST_INIT(adjectives, world.file2list("modular_psychonaut/master_files/strings/names/adjectives.txt"))
GLOBAL_LIST_INIT(adverbs, world.file2list("modular_psychonaut/master_files/strings/names/adverbs.txt"))
GLOBAL_LIST_INIT(dream_strings, world.file2list("modular_psychonaut/master_files/strings/dreamstrings.txt"))
...
GLOBAL_LIST_INIT(junkmail_messages, world.file2list("modular_psychonaut/master_files/strings/junkmail.txt"))
// PSYCHONAUT EDIT ADDITION END - LOCALIZATION
...
GLOBAL_LIST_INIT(verbs, world.file2list("modular_psychonaut/master_files/strings/names/verbs.txt"))
// PSYCHONAUT EDIT ADDITION END - LOCALIZATION
