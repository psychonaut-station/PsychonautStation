...
/datum/anonymous_theme/station/announce_to_all_players()
	priority_announce("[station_name()] yakınlarında 9. seviye gerçeklik hatası olayı doğrulandı. Tüm personel, kazara daha fazla gerçeklik olayını tetiklememek için ellerinden gelenin en iyisini yapmaya çalışmalıdır.", "[command_name()] Yüksek Boyutlu İlişkiler", 'sound/misc/notice1.ogg')
