...
/datum/controller/subsystem/dynamic/proc/send_intercept()
	...
	if(greenshift)
		priority_announce("Güvenlik ve istihbarat birimlerimizin yorulmak bilmeyen çabaları sayesinde, şu anda [station_name()] mürettebatına yönelik herhangi bir tehdit bulunmamaktadır. Tüm istasyon inşaat projelerine izin verilmiştir. Güvenli bir vardiya geçirin!", "Güvelik Raporu", SSstation.announcer.get_rand_report_sound(), color_override = "green")
	else
