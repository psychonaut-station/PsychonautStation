...
/obj/structure/bloodsucker/vassalrack
	...
	icon = 'psychonaut_modules/features/antagonists/bloodsuckers/icons/vamp_obj.dmi'
	...
	spawn(10)
		...
		/*	if(HAS_TRAIT(target, TRAIT_MINDSHIELD))
			...
			var/list/torture_icons = list(
				"Accept" = image(icon = 'psychonaut_modules/features/antagonists/bloodsuckers/icons/actions_bloodsucker.dmi', icon_state = "power_recup"),
...
/obj/structure/bloodsucker/bloodthrone
	...
	icon = 'psychonaut_modules/features/antagonists/bloodsuckers/icons/vamp_obj_64.dmi'
	icon_state = "throne"
	buckle_lying = 0
	anchored = FALSE
	density = TRUE
...
/obj/structure/bloodsucker/bloodthrone/proc/GetArmrest()
	return mutable_appearance('psychonaut_modules/features/antagonists/bloodsuckers/icons/vamp_obj_64.dmi', "thronearm")
