...
/datum/round_event/brand_intelligence/announce(fake)
	...
	priority_announce("[station_name()] yaygın marka istihbaratı tespit edildi. Lütfen tüm [machine_name] marka satıcılarını agresif pazarlama taktikleri açısından inceleyin ve gerekirse yeniden başlatın.", "Makine Öğrenimi Uyarısı")
