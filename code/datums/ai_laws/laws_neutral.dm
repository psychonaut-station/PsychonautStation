...
/datum/ai_laws/tyrant
	...
	inherent = list(
		...
		"Disiplinli davran.",
		"Sadece, statünü korumana ve geliştirmene destek verenlere yardım et.",
...
/datum/ai_laws/overlord
	...
	inherent = list(
		...
		"İnsanlar, birbirlerine ya da silikonlara zarar vermeye kalkışamaz.",
