/datum/antagonist/bloodsucker
	...
	hijack_speed = 0.5
	hud_icon = 'psychonaut_modules/features/antagonists/bloodsuckers/icons/bloodsucker_icons.dmi'
...
/datum/antagonist/bloodsucker/greet()
	...
	owner.current.playsound_local(null, 'psychonaut_modules/features/antagonists/bloodsuckers/sounds/BloodsuckerAlert.ogg', 100, FALSE, pressure_affected = FALSE)
...
/datum/antagonist/bloodsucker/proc/break_masquerade()
	if(broke_masquerade)
		return
	owner.current.playsound_local(null, 'psychonaut_modules/features/antagonists/bloodsuckers/sounds/lunge_warn.ogg', 100, FALSE, pressure_affected = FALSE)
