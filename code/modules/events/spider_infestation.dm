...
/datum/round_event/spider_infestation/announce(fake)
	priority_announce("[station_name()] doğru gelen tanımlanamayan yaşam sinyalleri tespit edildi. Kanallar ve havalandırma da dahil olmak üzere tüm dış erişimleri emniyete alın.", "Yaşam Sinyali", ANNOUNCER_ALIENS)
