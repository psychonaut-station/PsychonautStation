...
/datum/round_event/gravity_generator_blackout/announce(fake)
	priority_announce("[locale_suffix_genitive(station_name())] yakınlarında gravnosferik anomaliler tespit edildi. Jeneratörlerin manuel olarak sıfırlanması gerekmektedir.", "Anomali Uyarısı", ANNOUNCER_GRANOMALIES)
