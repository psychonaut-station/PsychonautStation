...
/datum/round_event/ghost_role/blob/announce(fake)
	...
	priority_announce("[locale_suffix_locative(station_name())] 5. seviye biyolojik tehlike salgını doğrulandı. Tüm personeller salgını kontrol altına almalıdır.", "Biyolojik Tehlike Uyarısı", ANNOUNCER_OUTBREAK5)
