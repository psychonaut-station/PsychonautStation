...
/datum/round_event/ghost_role/blob/announce(fake)
	...
	priority_announce("[locale_suffix_genitive(station_name())] içerisinde 5. seviye biyolojik tehlike salgını doğrulandı. Tüm personeller salgını kontrol altına almalıdır.", "Biyolojik Tehlike Uyarısı", ANNOUNCER_OUTBREAK5)
