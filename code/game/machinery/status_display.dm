...
/obj/machinery/status_display/proc/set_messages(line1, line2)
	line1 = locale_uppertext(line1) // PSYCHONAUT EDIT ADDITION - LOCALIZATION - Original: line1 = uppertext(line1)
	line2 = locale_uppertext(line2) // PSYCHONAUT EDIT ADDITION - LOCALIZATION - Original: line2 = uppertext(line2)
