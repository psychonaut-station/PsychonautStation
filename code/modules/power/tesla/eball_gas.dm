...
/datum/eball_gas/carbon_dioxide/extra_effects(obj/energy_ball/eball)
	...
	eball.absorbed_gasmix.assert_gases(/datum/gas/carbon_dioxide, /datum/gas/oxygen)

	var/consumed_co2 = eball.absorbed_gasmix.moles[/datum/gas/carbon_dioxide] * co2_ratio
	consumed_co2 = min(consumed_co2, eball.absorbed_gasmix.moles[/datum/gas/carbon_dioxide], eball.absorbed_gasmix.moles[/datum/gas/oxygen])

	if(!consumed_co2)
		return

	eball.absorbed_gasmix.assert_gas(/datum/gas/pluoxium)

	eball.absorbed_gasmix.adjust_multiple_gases(list(
