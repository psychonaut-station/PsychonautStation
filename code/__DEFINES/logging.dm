...
#define LOG_LOOC (1 << 22) // PSYCHONAUT ADDITION - LOOC
#define LOG_TRANSPORT (1 << 23) // PSYCHONAUT EDIT - LOOC - Original: #define LOG_TRANSPORT (1 << 22)
