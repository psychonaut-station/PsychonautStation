...
/datum/hallucination/station_message/blob_alert/start()
	priority_announce("[locale_suffix_genitive(station_name())] içerisinde 5. seviye biyolojik tehdit olduğu doğrulandı. Tüm personeller salgını kontrol altına almalıdır.", \
