/obj/item/melee/sabre
	...
	icon = 'modular_psychonaut/master_files/icons/obj/weapons/sword.dmi' // PSYCHONAUT EDIT ADDITION - CAPTAIN_SABRE - Original: icon = 'icons/obj/weapons/sword.dmi'
	icon_state = "sabre_red" // PSYCHONAUT EDIT ADDITION - CAPTAIN_SABRE - Original: icon_state = "sabre"
	inhand_icon_state = "sabre_red" // PSYCHONAUT EDIT ADDITION - CAPTAIN_SABRE - Original: inhand_icon_state = "sabre"
	icon_angle = -45
	lefthand_file = 'modular_psychonaut/master_files/icons/mob/inhands/weapons/swords_lefthand.dmi' // PSYCHONAUT EDIT ADDITION - CAPTAIN_SABRE - Original: lefthand_file = 'icons/mob/inhands/weapons/swords_lefthand.dmi'
	righthand_file = 'modular_psychonaut/master_files/icons/mob/inhands/weapons/swords_righthand.dmi' // PSYCHONAUT EDIT ADDITION - CAPTAIN_SABRE - Original: righthand_file = 'icons/mob/inhands/weapons/swords_righthand.dmi'
