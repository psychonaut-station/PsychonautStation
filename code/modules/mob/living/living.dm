...
/mob/living/proc/process_capture(ransom_price, black_market_price)
	if(ransom_price > 0)
		...
		priority_announce("Mürettebatınızdan biri rakip bir kuruluş tarafından esir alındı - onu geri getirmek için fidye ödenmesi gerekiyor. Politikamız gereği, toplam maliyeti dengelemek için istasyonun fonlarının bir kısmını aldık.", "Nanotrasen Varlık Koruma", has_important_message = TRUE)
