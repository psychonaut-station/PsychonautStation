...
/datum/controller/subsystem/credits/proc/draft_episode_names()
	...
	episode_names += new /datum/episode_name("İSTASYONUN [pick("UZAY", "SEKSİ", "EJDERHA", "BÜYÜCÜ", "ÇAMAŞIR", "SİLAH", "REKLAM", "KÖPEK", "KARBONMONOKSİT", "NİNJA", "SİHİRBAZ", "SOKRATİK", "GENÇLİK SUÇLULUĞU", "POLİTİK GÜDÜMLÜ", "RADİKAL DERECEDE HARİKA", "KURUMSAL", "MEGA")] [pick("MACERASI", "GÜCÜ", "YOLCULUĞU")]", 25)
