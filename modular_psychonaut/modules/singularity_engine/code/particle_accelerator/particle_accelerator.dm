...
/obj/machinery/particle_accelerator
	...
	icon = 'modular_psychonaut/master_files/icons/obj/machines/engine/particle_accelerator.dmi'
	icon_state = "none"
	density = TRUE
	anchored = FALSE
	var/reference = null
...
/obj/machinery/particle_accelerator/full
	...
	icon = 'modular_psychonaut/master_files/icons/obj/machines/engine/128x128.dmi'
	icon_state = "pac"
	anchored = TRUE
